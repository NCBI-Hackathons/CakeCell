...
<b> Hackathon team: Jay Newby (Lead), Kevin Curran (Sys Admin), Mike Pablo (Writer),  Sherry Chao, Ben Walker, Ian Seim </b>
...
## People
- [Jay Newby](http://newby.web.unc.edu/), UNC, Chapel Hill, NC,
- [Kevin Curran](), UNC, Chapel Hill, NC
